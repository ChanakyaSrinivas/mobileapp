...
/**
 * Provides the local service interface for MobileUserDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author MVIDYA
 * @see MobileUserDetailsLocalServiceUtil
...
public interface MobileUserDetailsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MobileUserDetailsLocalServiceUtil} to access the mobile user details local service. Add custom service methods to {@link com.vidyayug.mobile.service.impl.MobileUserDetailsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
